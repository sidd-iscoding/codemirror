...
function Body(props){
    ...
    const [inputBox, setInputBox] = useState(() => {
        ...
        const initialValue = JSON.parse(saved);
        return initialValue || "hello world";
    });
    ...
    return(
        ...
        {...other}>
             {value === index && (<Box sx={{ p: 3 }}> <Typography  component={'div'}>
      ...
      />
      <Grid container sx={{ m: 1 , border: 1 }} spacing={2} >
         <Grid item  lg={6} sm={6} md={6} xs={12}  > 
          ...
          <Grid item  lg={6} sm={6} md={6} xs={12}  >
            <CodeMirror  className="CodemDisplay"
                        value={outBox}
                        style={{ }}
